import {
  ...
  type GoogleAdsPerformanceMaxAssetGroupStatsCollectorDependencies,
  type GoogleAdsPerformanceMaxAssetGroupStatsCollectorOptions,
  type GoogleAdsPerformanceMaxAssetGroupStatsPageCollectionResult,
  type GoogleAdsPerformanceMaxAssetGroupStatsPageCursor,
...
export type GoogleAdsAllDataPerformanceMaxStagingOrchestratorErrorCode =
  | "INVALID_INPUT"
  | "INVALID_JOB"
  | "INVALID_CURSOR"
  | "INVALID_APPEND_RESULT";

export class GoogleAdsAllDataPerformanceMaxStagingOrchestratorError
  extends Error {
  readonly code:
    GoogleAdsAllDataPerformanceMaxStagingOrchestratorErrorCode;
  ...
  constructor(
    ...
    this.name =
      "GoogleAdsAllDataPerformanceMaxStagingOrchestratorError";
...
export type GoogleAdsAllDataPerformanceMaxStagingCursor =
  Readonly<{
    version: 1;
...
export type GoogleAdsAllDataPerformanceMaxStagingCheckpoint =
  Readonly<{
    version: 1;
    dateWindowIndex: number;
    nextRowIndex: number;
...
export type GoogleAdsAllDataPerformanceMaxStagingOrchestratorInput =
  Readonly<{
    job:
      MediaSyncJobRecord;
...
export type GoogleAdsAllDataPerformanceMaxStagingOrchestratorDependencies =
  Readonly<{
    collectPage?:
      typeof collectGoogleAdsPerformanceMaxAssetGroupStatsPage;

    appendBatch?:
      typeof appendMediaSyncStagingBatch;
  }>;

export type GoogleAdsAllDataPerformanceMaxStagingOrchestratorResult =
  Readonly<{
    jobId: string;
    dateWindowIndex: number;
    ...
    checkpoint:
      GoogleAdsAllDataPerformanceMaxStagingCheckpoint;
  }>;
...
function normalizeRequiredString(
  ...
  if (typeof value !== "string") {
    throw new GoogleAdsAllDataPerformanceMaxStagingOrchestratorError(
      "INVALID_JOB",
...
function validateJob(
  ...
  if (
    ...
    throw new GoogleAdsAllDataPerformanceMaxStagingOrchestratorError(
      "INVALID_JOB",
      "The ALL-DATA Performance Max staging job is required.",
    );
  }
  ...
  if (
    ...
    throw new GoogleAdsAllDataPerformanceMaxStagingOrchestratorError(
      "INVALID_JOB",
      "ALL-DATA Performance Max staging requires a Google Ads job.",
    );
  }
  ...
  if (
    ...
    throw new GoogleAdsAllDataPerformanceMaxStagingOrchestratorError(
      "INVALID_JOB",
      "ALL-DATA Performance Max staging requires the Google Ads ALL-DATA execution contract.",
    );
  }
  ...
  if (
    ...
    throw new GoogleAdsAllDataPerformanceMaxStagingOrchestratorError(
      "INVALID_JOB",
      "ALL-DATA Performance Max staging requires a processing job.",
    );
  }
  ...
  if (
    ...
    throw new GoogleAdsAllDataPerformanceMaxStagingOrchestratorError(
      "INVALID_JOB",
      "ALL-DATA Performance Max staging job date range is invalid.",
    );
  }
  ...
  if (
    ...
    throw new GoogleAdsAllDataPerformanceMaxStagingOrchestratorError(
      "INVALID_JOB",
      "ALL-DATA Performance Max staging job claim state is invalid.",
    );
  }
...
function resolveCollectorCursor(
  ...
  if (
    ...
    throw new GoogleAdsAllDataPerformanceMaxStagingOrchestratorError(
      "INVALID_CURSOR",
      "ALL-DATA Performance Max staging cursor must be an object.",
    );
  }
  ...
  if (
    ...
    throw new GoogleAdsAllDataPerformanceMaxStagingOrchestratorError(
      "INVALID_CURSOR",
      "ALL-DATA Performance Max staging cursor scope does not match the claimed job.",
    );
  }
  ...
  if (
    ...
    throw new GoogleAdsAllDataPerformanceMaxStagingOrchestratorError(
      "INVALID_CURSOR",
      "ALL-DATA Performance Max staging cursor row boundary does not match job.inserted_rows.",
    );
  }
  ...
  if (
    ...
    throw new GoogleAdsAllDataPerformanceMaxStagingOrchestratorError(
      "INVALID_CURSOR",
      "ALL-DATA Performance Max staging cursor page is invalid.",
    );
  }
...
function validateAppendBoundary(
  ...
  if (
    ...
    throw new GoogleAdsAllDataPerformanceMaxStagingOrchestratorError(
      "INVALID_APPEND_RESULT",
      "ALL-DATA Performance Max staging append submitted-row count does not match the page.",
    );
  }
  ...
  if (
    ...
    if (
      ...
      throw new GoogleAdsAllDataPerformanceMaxStagingOrchestratorError(
        "INVALID_APPEND_RESULT",
        "Empty ALL-DATA Performance Max staging append returned a row-index boundary.",
      );
    }
  ...
  if (
    ...
    throw new GoogleAdsAllDataPerformanceMaxStagingOrchestratorError(
      "INVALID_APPEND_RESULT",
      "ALL-DATA Performance Max staging append row-index boundary is invalid.",
    );
  }
}

export async function runGoogleAdsAllDataPerformanceMaxStagingOrchestrator(
  input:
    GoogleAdsAllDataPerformanceMaxStagingOrchestratorInput,
  dependencies:
...
> {
  if (
    ...
    throw new GoogleAdsAllDataPerformanceMaxStagingOrchestratorError(
      "INVALID_INPUT",
      "ALL-DATA Performance Max staging orchestration input is required.",
    );
  }
