...
import {
  ...
  type GoogleAdsDisplayAdCanonicalAd,
  type GoogleAdsDisplayAdCanonicalAdGroup,
  type GoogleAdsDisplayAdCanonicalCampaign,
  type GoogleAdsDisplayAdDailyStatsRecord,
...
export const GOOGLE_ADS_DISPLAY_AD_STATS_REQUEST_TIMEOUT_MS =
  30_000;

export const GOOGLE_ADS_DISPLAY_AD_STATS_MAX_RETRIES =
  3;

export const GOOGLE_ADS_DISPLAY_AD_STATS_MAX_PAGES =
  1_000;
 ...
 */
export const GOOGLE_ADS_DISPLAY_AD_STATS_PAGE_SIZE =
  10_000;

const GOOGLE_ADS_DISPLAY_AD_STATS_BASE_RETRY_DELAY_MS =
  1_000;

const GOOGLE_ADS_DISPLAY_AD_STATS_MAX_RETRY_DELAY_MS =
  30_000;

export type GoogleAdsDisplayAdStatsCollectorErrorCode =
  | "INVALID_INPUT"
  | "REQUEST_TIMEOUT"
  | "REQUEST_FAILED"
  | "API_HTTP_ERROR"
...
export class GoogleAdsDisplayAdStatsCollectorError
  extends Error {
  readonly code:
    GoogleAdsDisplayAdStatsCollectorErrorCode;
  ...
  constructor(
    ...
    this.name =
      "GoogleAdsDisplayAdStatsCollectorError";
...
export type GoogleAdsDisplayAdStatsCollectorInput =
  Readonly<{
    accessToken: string;
...
export type GoogleAdsDisplayAdStatsCollectorDependencies =
  Readonly<{
...
export type GoogleAdsDisplayAdStatsCollectorOptions =
  Readonly<{
...
export type GoogleAdsDisplayAdStatsPageCursor =
  Readonly<{
    version: 1;
    pageIndex: number;
    page: string;
...
export type GoogleAdsDisplayAdStatsPageCollectorInput =
  GoogleAdsDisplayAdStatsCollectorInput &
    Readonly<{
      cursor?: unknown;
    }>;

export type GoogleAdsDisplayAdStatsSearchRequest =
  Readonly<{
    endpoint: string;
    method: "POST";
    headers:
...
export type GoogleAdsDisplayAdStatsPageCollectionResult =
  Readonly<{
    rows:
...
type ParsedGoogleAdsDisplayAdStatsRow =
  Readonly<{
    campaign:
      GoogleAdsDisplayAdCanonicalCampaign;

    adGroup:
      GoogleAdsDisplayAdCanonicalAdGroup;

    ad:
      GoogleAdsDisplayAdCanonicalAd;

    record:
      GoogleAdsDisplayAdDailyStatsRecord;
  }>;

type ParsedSearchPage =
  Readonly<{
    rows:
      readonly ParsedGoogleAdsDisplayAdStatsRow[];
...
function normalizeRequiredString(
  ...
  if (typeof value !== "string") {
    throw new GoogleAdsDisplayAdStatsCollectorError(
      "INVALID_INPUT",
...
function normalizePageToken(
  ...
  if (typeof value !== "string") {
    throw new GoogleAdsDisplayAdStatsCollectorError(
      "INVALID_RESPONSE",
      "Google Ads Display ad nextPageToken is invalid.",
    );
  }
...
function normalizeCursor(
  ...
  if (!isPlainObject(value)) {
    throw new GoogleAdsDisplayAdStatsCollectorError(
      "INVALID_INPUT",
      "Google Ads Display ad page cursor must be an object.",
    );
  }
  ...
  if (value.version !== 1) {
    throw new GoogleAdsDisplayAdStatsCollectorError(
      "INVALID_INPUT",
      "Google Ads Display ad page cursor version is invalid.",
    );
  }
  ...
  if (
    ...
    throw new GoogleAdsDisplayAdStatsCollectorError(
      "INVALID_INPUT",
      "Google Ads Display ad page cursor index is invalid.",
    );
  }
...
function normalizeCustomerIds(
  ...
  try {
    ...
    throw new GoogleAdsDisplayAdStatsCollectorError(
      "INVALID_INPUT",
      "Google Ads Display ad customer ID is invalid.",
      {
        cause:
          error,
      },
...
export function buildGoogleAdsDisplayAdStatsQuery(
  input: Readonly<{
    startDate: unknown;
    endDate: unknown;
  }>,
...
export function buildGoogleAdsDisplayAdStatsSearchRequest(
  input:
    GoogleAdsDisplayAdStatsCollectorInput &
    Readonly<{
      pageToken?: unknown;
    }>,
): GoogleAdsDisplayAdStatsSearchRequest {
  const accessToken =
    normalizeRequiredString(
      input.accessToken,
      "accessToken",
  ...
  const query =
    buildGoogleAdsDisplayAdStatsQuery(
      {
        startDate:
          input.startDate,
        endDate:
...
function parseSearchRow(
  value: unknown,
  rowIndex: number,
): ParsedGoogleAdsDisplayAdStatsRow {
  if (!isPlainObject(value)) {
    throw new GoogleAdsDisplayAdStatsCollectorError(
      "INVALID_RESPONSE",
...
function parseSearchResponse(
  ...
  if (!isPlainObject(value)) {
    throw new GoogleAdsDisplayAdStatsCollectorError(
      "INVALID_RESPONSE",
      "Google Ads Display ad response must be an object.",
    );
  }
  ...
  if (!Array.isArray(rawResults)) {
    throw new GoogleAdsDisplayAdStatsCollectorError(
      "INVALID_RESPONSE",
      "Google Ads Display ad results must be an array.",
    );
  }
...
function toCanonicalRows(
  ...
  for (const row of rows) {
    ...
    if (
      ...
      throw new GoogleAdsDisplayAdStatsCollectorError(
        "INVALID_RESPONSE",
        "Google Ads Display ad response repeated an entity with inconsistent names.",
      );
    }
  ...
  try {
    ...
    try {
      ...
      if (
        ...
        throw new GoogleAdsDisplayAdStatsCollectorError(
          "REQUEST_TIMEOUT",
          "Google Ads Display ad request timed out.",
          {
            cause:
              error,
          },
      ...
      throw new GoogleAdsDisplayAdStatsCollectorError(
        "REQUEST_FAILED",
        "Google Ads Display ad request failed.",
        {
          cause:
            error,
        },
    ...
    if (!response.ok) {
      throw new GoogleAdsDisplayAdStatsCollectorError(
        "API_HTTP_ERROR",
        "Google Ads Display ad request returned an unsuccessful response.",
        {
          status:
            response.status,
        },
    ...
    try {
      ...
      throw new GoogleAdsDisplayAdStatsCollectorError(
        "INVALID_RESPONSE",
        "Google Ads Display ad request returned invalid JSON.",
        {
          cause:
            error,
        },
...
function calculateRetryDelayMs(
  ...
  const base =
    Math.min(
      GOOGLE_ADS_DISPLAY_AD_STATS_BASE_RETRY_DELAY_MS *
        2 ** retryIndex,

      GOOGLE_ADS_DISPLAY_AD_STATS_MAX_RETRY_DELAY_MS,
    );
...
export async function collectGoogleAdsDisplayAdStatsPage(
  input:
    GoogleAdsDisplayAdStatsPageCollectorInput,
  dependencies:
...
> {
  if (
    ...
    throw new GoogleAdsDisplayAdStatsCollectorError(
      "INVALID_INPUT",
      "Google Ads Display ad page collector input is required.",
    );
  }
   ...
   */
  buildGoogleAdsDisplayAdStatsSearchRequest(
    input,
  );
  ...
  const requestTimeoutMs =
    normalizeBoundedInteger(
      options.requestTimeoutMs ??
        GOOGLE_ADS_DISPLAY_AD_STATS_REQUEST_TIMEOUT_MS,
      "requestTimeoutMs",
      1,
      60_000,
    );
  ...
  const maxRetries =
    normalizeBoundedInteger(
      options.maxRetries ??
        GOOGLE_ADS_DISPLAY_AD_STATS_MAX_RETRIES,
      "maxRetries",
      0,
      10,
    );
  ...
  const maxPages =
    normalizeBoundedInteger(
      options.maxPages ??
        GOOGLE_ADS_DISPLAY_AD_STATS_MAX_PAGES,
      "maxPages",
      1,
      10_000,
    );
  ...
  if (
    ...
    throw new GoogleAdsDisplayAdStatsCollectorError(
      "PAGE_LIMIT_EXCEEDED",
      "Google Ads Display ad request exceeded the bounded page limit.",
    );
  }
  ...
  for (;;) {
    ...
    try {
      ...
      if (
        ...
        throw new GoogleAdsDisplayAdStatsCollectorError(
          "RETRY_EXHAUSTED",
          "Google Ads Display ad retry limit was reached.",
          {
            status:
              error.status,
      ...
      try {
        ...
        throw new GoogleAdsDisplayAdStatsCollectorError(
          "REQUEST_FAILED",
          "Google Ads Display ad retry delay failed.",
          {
            cause:
              sleepError,
  ...
  if (!page) {
    throw new GoogleAdsDisplayAdStatsCollectorError(
      "INVALID_RESPONSE",
      "Google Ads Display ad page was not produced.",
    );
  }
  ...
  if (
    ...
    throw new GoogleAdsDisplayAdStatsCollectorError(
      "PAGINATION_LOOP",
      "Google Ads Display ad request repeated the current page token.",
    );
  }
  ...
  if (
    page.rows.length >
    GOOGLE_ADS_DISPLAY_AD_STATS_PAGE_SIZE
  ) {
    throw new GoogleAdsDisplayAdStatsCollectorError(
      "INVALID_RESPONSE",
      "Google Ads Display ad page exceeded the fixed page row limit.",
    );
  }
