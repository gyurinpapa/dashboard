...
} from "../src/lib/media-sync/google-ads-all-data-display-staging-orchestrator";
import type {
...
async function main():
  ...
  const first =
    await runGoogleAdsAllDataDisplayStagingOrchestrator(
      {
        job:
          createJob(
            5,
  ...
  console.log(
    "DISPLAY_AD_ROW_START_FROM_JOB_INSERTED_ROWS=PASS",
  );

  console.log(
    "DISPLAY_AD_PARTIAL_CURSOR_PRESERVED=PASS",
  );
  ...
  console.log(
    "DISPLAY_AD_STALE_ROW_BOUNDARY_FAILS_BEFORE_API=PASS",
  );
  ...
  console.log(
    "DISPLAY_AD_GLOBAL_ROW_INDEX_CONTINUITY=PASS",
  );

  console.log(
    "DISPLAY_AD_ONE_PAGE_PER_INVOCATION=PASS",
  );
  ...
  console.log(
    "DISPLAY_AD_LEGACY_JOB_FAILS_BEFORE_API=PASS",
  );

  console.log(
    "GOOGLE_ADS_ALL_DATA_DISPLAY_STAGING_ORCHESTRATOR_FIXTURE=PASS",
  );
