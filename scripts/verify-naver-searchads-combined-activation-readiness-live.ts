...
async function main():
  ...
  console.log(
    "combined live activation readiness verification date range:",
  ...
  console.log(
    "actual activation RPC and finalization are blocked:",
    true,
  );
  ...
  try {
    ...
    let expectedActivationReadinessBlockObserved =
      false;
    ...
    for (
      ...
      try {
        ...
        expectedActivationReadinessBlockObserved =
          true;
        ...
        console.log(
          "real materialization completed and activation readiness verified before blocker:",
          JSON.stringify({
            claimNumber,
            attemptCount:
              claimedJob.attempt_count,
...
main().catch(
  (error: unknown) => {
    if (
      ...
      console.error(
        "combined live activation readiness verification failed:",
        JSON.stringify(
          readSafeErrorChain(
            error,
          ),
