...
import {
  ...
  type GoogleAdsSearchAdStagingOrchestratorDependencies,
...
async function main():
  ...
  const first =
    await runGoogleAdsSearchAdStagingOrchestrator(
      {
        job:
          createJob(
            5,
  ...
  console.log(
    "SEARCH_AD_ROW_START_FROM_JOB_INSERTED_ROWS=PASS",
  );

  console.log(
    "SEARCH_AD_PARTIAL_CURSOR_PRESERVED=PASS",
  );
  ...
  console.log(
    "SEARCH_AD_STALE_ROW_BOUNDARY_FAILS_BEFORE_API=PASS",
  );
  ...
  console.log(
    "SEARCH_AD_GLOBAL_ROW_INDEX_CONTINUITY=PASS",
  );

  console.log(
    "SEARCH_AD_ONE_PAGE_PER_INVOCATION=PASS",
  );
  ...
  console.log(
    "SEARCH_AD_LEGACY_JOB_FAILS_BEFORE_API=PASS",
  );

  console.log(
    "GOOGLE_ADS_SEARCH_AD_STAGING_ORCHESTRATOR_FIXTURE=PASS",
  );
