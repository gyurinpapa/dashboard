...
function getDensityClasses(density: Summary2HeatmapDensity) {
  if (density === "export-wide") {
    return {
      section:
        "flex h-full min-h-[300px] flex-col rounded-[22px] border border-slate-200/90 bg-white p-4 shadow-[0_10px_26px_rgba(15,23,42,0.06)]",
      headerGap: "mb-3",
      eyebrow: "text-[10px]",
      ...
      legend: "text-[10px]",
      board:
        "flex-1 rounded-[18px] border border-slate-200 bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(248,250,252,0.92))] p-3.5",
      weekday: "text-[9px]",
      gridGap: "gap-1.5",
      cell:
        "rounded-lg text-[11px] transition-transform duration-150 hover:scale-[1.05]",
  ...
  if (density === "export-compact") {
    return {
      section:
        "flex h-full min-h-[260px] flex-col rounded-[20px] border border-slate-200/90 bg-white p-3 shadow-[0_8px_22px_rgba(15,23,42,0.06)]",
      headerGap: "mb-3",
      eyebrow: "text-[9px]",
      ...
      legend: "text-[9px]",
      board:
        "flex-1 rounded-[16px] border border-slate-200 bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(248,250,252,0.92))] p-3",
      weekday: "text-[8px]",
      gridGap: "gap-1.5",
      cell:
        "rounded-lg text-[10px] transition-transform duration-150 hover:scale-[1.05]",
  ...
  if (density === "export-side-compact") {
    return {
      section:
        "flex h-full min-h-[220px] flex-col rounded-[18px] border border-slate-200/90 bg-white p-2.5 shadow-[0_8px_20px_rgba(15,23,42,0.05)]",
      headerGap: "mb-2",
      eyebrow: "text-[8px]",
      ...
      legend: "text-[8px]",
      board:
        "flex-1 rounded-[14px] border border-slate-200 bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(248,250,252,0.92))] p-2.5",
      weekday: "text-[8px]",
      gridGap: "gap-1",
      cell:
        "rounded-md text-[9px] transition-transform duration-150 hover:scale-[1.05]",
  ...
  return {
    section:
      "flex h-full min-h-[320px] flex-col rounded-[24px] border border-slate-200/90 bg-white p-5 shadow-[0_10px_30px_rgba(15,23,42,0.06)]",
    headerGap: "mb-4",
    eyebrow: "text-[11px]",
    ...
    legend: "text-[11px]",
    board:
      "flex-1 rounded-[20px] border border-slate-200 bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(248,250,252,0.92))] p-4",
    weekday: "text-[10px]",
    gridGap: "gap-2",
    cell:
      "rounded-xl text-xs transition-transform duration-150 hover:scale-[1.05]",
...
export default function Summary2HeatmapView({
  ...
  return (
    <section className={[densityClasses.section, className ?? ""].join(" ")}>
      <div
        className={`flex items-start justify-between gap-3 ${densityClasses.headerGap}`}
      >
        <div>
          <div
        ...
        <div
          className={`flex items-center gap-2 text-slate-500 ${densityClasses.legend}`}
        >
      ...
      <div className={densityClasses.stats}>
        <div className={densityClasses.statCard}>
          <div className={`text-slate-500 ${densityClasses.statLabel}`}>
            최고 성과일
          </div>
          <div
