...
export async function POST(req: Request) {
  try {
    ...
    const fromYMD = normalizeToYMD(metaFrom) ?? normalizeToYMD(report.period_start);
    const toYMD = normalizeToYMD(metaTo) ?? normalizeToYMD(report.period_end);
